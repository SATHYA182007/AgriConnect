...
import { 
  Bell, Sprout, ShoppingBag, TrendingUp, Cloud, 
...
const FarmerDashboard = () => {
  ...
  const menuItems = [
    { id: 'overview', path: '/farmer/overview', icon: LayoutDashboard, label: 'Overview' },
    { id: 'crops', path: '/farmer/crops', icon: Sprout, label: 'My Crops' },
    { id: 'market', path: '/farmer/market', icon: ShoppingBag, label: 'Marketplace' },
    { id: 'ai', path: '/farmer/ai', icon: TrendingUp, label: 'AI Analytics' },
    { id: 'weather', path: '/farmer/weather', icon: Cloud, label: 'Weather' }
  ];

  return (
    <div className="farmer-dashboard" style={{ display: 'flex', minHeight: '100vh', background: 'var(--background)' }}>
      {/* Sidebar Navigation */}
      ...
      <main style={{ marginLeft: '280px', flex: 1, padding: '40px 60px', minHeight: '100vh' }}>
        ...
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px' }}>
          <div>
            <h1 style={{ fontSize: '30px', marginBottom: '4px' }}>Welcome Back, Farmer!</h1>
            <p style={{ color: '#64748b' }}>Technical health monitoring and market data for Mar 30, 2026.</p>
          </div>
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center' }}>
            ...
            <div className="glass" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '6px 16px 6px 6px', borderRadius: '40px' }}>
              <div style={{ width: '36px', height: '36px', borderRadius: '50%', background: 'var(--primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 600 }}>SA</div>
              <div style={{ fontSize: '14px', fontWeight: 600 }}>Satyam Agri</div>
            </div>
          </div>
        </header>
